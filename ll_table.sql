...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2013 at 07:59 AM
...
CREATE TABLE IF NOT EXISTS `ll_table` (
  ...
  `numUserRating` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
